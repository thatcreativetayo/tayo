  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Front — blank */}
        <div
          className="absolute border border-base/5 inset-0 bg-[#F5F5F5]"
...
export default function Testimonials() {
  return (
    <section className="flex flex-col items-center px-6 py-20 gap-12">
      ...
      >
        <h1 className="text-base text-5xl font-semibold leading-tight tracking-tight">
      ...
      {/* Grid */}
      <div
        className="w-full max-w-7xl grid grid-cols-3"
        // style={{
